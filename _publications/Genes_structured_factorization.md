...
permalink: /publication/Genes_structured_factorization.md
excerpt: ''
date: 2026-02-19
...
incorporate external knowledge, such as biological pathways, into the model’s prior distribution. This
approach promotes sparsity in the factor loadings facilitating their interpretation and that of the
corresponding latent factors. We demonstrate the effectiveness of our model on single-cell RNA
sequencing data obtained from cord blood mononuclear cells, revealing promising insights into the role of
pathways in characterizing gene relationships and extracting valuable information about unobserved cell traits.

[Link to the paper](https://doi.org/10.1093/jrsssc/qlag009)
